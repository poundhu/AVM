...
public class CommonSuperClassTarget_combineWithApi {
    ...
    public static String combineApiWithApi(boolean flag, Result a, BlockchainRuntime b) {
        return (flag ? a : b).toString();
    }

    public static Object combineApiWithNull(boolean flag, BlockchainRuntime runtime) {
